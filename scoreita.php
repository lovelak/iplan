...
<div class="row">
  ...
  <form action="scoreitaadd.php" method="post" enctype="multipart/form-data" name="frmProject" >
  <div class="row">
  	<div class="col-sm-6">
  		<label >ผลคะแนน ITA ประจำปี</label>
...
function selectlocaloffice(){
	...
	$.post("table_ita.php", { amphures : amphures ,provinces: provinces,sltYear : sltYear},
		function(data){
			$("#ita").html(data);
		}
	);
