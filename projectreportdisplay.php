...
<html lang="en">
    ...
    <script type="text/javascript">
        function changeYear(selectValue){
            if (selectValue == ""){
                $("#projectReportDisplay").load("ajax/getProjectReportDisplay.php?q='0'");
            } else {
                $("#projectReportDisplay").load("ajax/getProjectReportDisplay.php?q=" + selectValue);
            }
        }
    </script>
...
<div id='projectReportDisplay'></div>
