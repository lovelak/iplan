...
<script type="text/javascript">
    ...
    //     if (selectValue == ""){
    //         $("#projectDisplay").load("ajax/getProjectDisplay.php?q='0'");
    //     } else {
    //         $("#projectDisplay").load("ajax/getProjectDisplay.php?q=" + selectValue);
    //     }
    // }
		function changeYear(selectValue) {
				var selectAmphur = document.getElementById('selectAmphur');
				//var roundSelected = document.getElementById('selectRound');
				//var provinceSeleted = document.getElementById("selectProvince");
				$("#projectDisplay").load("ajax/getProjectDisplay.php?a=" + selectAmphur.value + "&q=" + selectValue );
		...
		function changeAmphur(selectValue2) {
				...
				//var roundSelected = document.getElementById('selectRound');
				//var provinceSeleted = document.getElementById("selectProvince");
				$("#projectDisplay").load("ajax/getProjectDisplay.php?a=" + selectValue2 + "&q=" + yearSelected.value );

		}
</script>
<select name="yearProject" id="yearProject" onchange="changeYear(this.value)" required>
        <option value="0" selected>กรุณาเลือกปีที่ต้องดำเนินการ</option>
		...
		<select name ="amphur" id="selectAmphur" onchange="changeAmphur(this.value)" required>
