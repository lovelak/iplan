...
//    }
    ...
    $y = $_GET['y'];
    if ($r == 1){
        $table_area = "v_6month_implement_area";
        $table_province = "v_6month_implement_province";
    } else {
        $table_area = "v_implement_area";
        $table_province = "v_implement_province";
    }
    if ($y == "0" && $a == "0"){
        $sql="SELECT * FROM $table_area ORDER BY area";
    } else if ($y == "0" && $a != "0") {
        $sql="SELECT * FROM $table_province WHERE area=$a ORDER BY PROVINCE_ID";
    } else if ($y != "0" && $a == "0") {
        if ($y == "2561") {
            $sql="SELECT * FROM $table_area ORDER BY implementY1 DESC";
        } else if ($y == "2562") {
            $sql="SELECT * FROM $table_area ORDER BY implementY2 DESC";
        } else if ($y == "2563") {
            $sql="SELECT * FROM $table_area ORDER BY implementY3 DESC";
        } else if ($y == "2564") {
            $sql="SELECT * FROM $table_area ORDER BY implementY4 DESC";
        }
    } else if ($y != "0" && $a != "0") {
        if ($y == "2561") {
...
//    echo $p;
    if (($y == "0" && $a == "0")) {
        echo "<h2>มี อปท. บันทึกโครงการแล้วจำนวน $num ภาค ดังนี้ </h2>
