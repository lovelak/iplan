...
//    $y = $_GET['y'];
    if ($y == "0" && $a == "0"){
        $sql="SELECT * FROM v_implement_amphur WHERE PROVINCE_ID=$p ORDER BY AMPHUR_ID DESC";
    } else if ($y == "0" && $a != "0") {
        $sql="SELECT * FROM v_implement_full WHERE AMPHUR_ID=$a AND PROVINCE_ID=$p ORDER BY local_office_id DESC";
    } else if ($y != "0" && $a == "0") {
        if ($y == "2561") {
        ...
        if ($y == "2561") {
            $sql="SELECT * FROM v_implement_full WHERE AMPHUR_ID=$a AND PROVINCE_ID=$p ORDER BY implementY1 DESC";
        } else if ($y == "2562") {
            $sql="SELECT * FROM v_implement_full WHERE AMPHUR_ID=$a AND PROVINCE_ID=$p ORDER BY implementY2 DESC";
        } else if ($y == "2563") {
            $sql="SELECT * FROM v_implement_full WHERE AMPHUR_ID=$a AND PROVINCE_ID=$p ORDER BY implementY3 DESC";
        } else if ($y == "2564") {
            $sql="SELECT * FROM v_implement_full WHERE AMPHUR_ID=$a AND PROVINCE_ID=$p ORDER BY implementY4 DESC";
        }
    }
