 ...
 ?>
    ...
    <head>
        ...
        <script type="text/javascript">
            function changeYear(selectValue) {
                if (selectValue == "") {
                    $("#projectScore").load("ajax/getProjectScore.php?y='0'");
                } else {
                    $("#projectScore").load("ajax/getProjectScore.php?y=" + selectValue);
                }
            }
  ...
  ?>
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">ผลการนำแผนไปปฏิบัติ</li>
                        </ul>
                        <!-- /.breadcrumb -->
        ...
        <option value="2564">2564
                                    ...
                                    <div id='projectScore'></div>
                                    <div id='projectScore2'></div>
                                    <div id='projectScore3'></div>
